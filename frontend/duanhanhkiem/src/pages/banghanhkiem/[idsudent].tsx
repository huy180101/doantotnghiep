...
import { listConductPoints } from './datajson';

const { Header, Content, Footer } = Layout;
import useSWRMutation from "swr/mutation";
import { student } from '@/services/student';
import { deepCopy, fetcher_$POST, notificationError, notificationSuccess } from '@/common/functionglobal';
...
export default function BangHanhKiem() {
    ...
    useEffect(() => {
        ...
        if (getModifyConduct?.student_point_1_1) {
            ...
            copyLstTable[2].cadre_points = getModifyConduct.officer_point_1_1;
            copyLstTable[3].cadre_points = getModifyConduct.officer_point_1_2;
            copyLstTable[4].cadre_points = getModifyConduct.officer_point_1_3;
            copyLstTable[5].cadre_points = getModifyConduct.officer_point_1_4;
            copyLstTable[6].cadre_points = getModifyConduct.officer_point_1_5;

            copyLstTable[8].cadre_points = getModifyConduct.officer_point_2_1;
            copyLstTable[9].cadre_points = getModifyConduct.officer_point_2_2;
            copyLstTable[10].cadre_points = getModifyConduct.officer_point_2_3;
            copyLstTable[11].cadre_points = getModifyConduct.officer_point_2_4;
            copyLstTable[12].cadre_points = getModifyConduct.officer_point_2_5;
            copyLstTable[13].cadre_points = getModifyConduct.officer_point_2_6;

            copyLstTable[15].cadre_points = getModifyConduct.officer_point_3_1;
            copyLstTable[16].cadre_points = getModifyConduct.officer_point_3_2;
            copyLstTable[17].cadre_points = getModifyConduct.officer_point_3_3;
                        ...
                        children: (
                            ((getInfoCurrentUser.type == 'teacher' || getInfoCurrentUser.type == 'student' || (getInfoCurrentUser.is_officer)) && index != 25) ?
                                ...
                                <div className='font-bold'>
                                    {(index === 25) ? Self_assessment : record.cadre_points}
                                </div>
                        ),
                        props: {},
                    };
    ...
    const handleFormSubmit = async (values: any) => {
        ...
        let data: any = {
            ...
            "officer_point_1": 0,
            "officer_point_1_1": lstTable[2].cadre_points,
            "officer_point_1_2": lstTable[3].cadre_points,
            "officer_point_1_3": lstTable[4].cadre_points,
            "officer_point_1_4": lstTable[5].cadre_points,
            "officer_point_1_5": lstTable[6].cadre_points,
            "officer_point_2": 0,
            "officer_point_2_1": lstTable[8].cadre_points,
            "officer_point_2_2": lstTable[9].cadre_points,
            "officer_point_2_3": lstTable[10].cadre_points,
            "officer_point_2_4": lstTable[11].cadre_points,
            "officer_point_2_5": lstTable[12].cadre_points,
            "officer_point_2_6": lstTable[13].cadre_points,
            "officer_point_3": 0,
            "officer_point_3_1": lstTable[15].cadre_points,
            "officer_point_3_2": lstTable[16].cadre_points,
            "officer_point_3_3": lstTable[17].cadre_points,
            "officer_point_4": 0,
                ...
                <div className="site-layout-content h-full" style={{ background: colorBgContainer }}>
                    ...
                    </Table>
                    {
                        ...
                        && <div className="grid justify-items-end">
                            <div>
                                <Form layout="horizontal" form={form} onFinish={handleFormSubmit}>
                                    <Item
                                        name="total_point"
                    ...
                    <div className="grid justify-items-end">
                        <Button className="bg-blue-500" onClick={() => { form.submit() }} type="primary">Lưu</Button>
                    </div>
